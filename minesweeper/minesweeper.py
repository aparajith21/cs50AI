...
class MinesweeperAI():
    ...
    def add_knowledge(self, cell, count):
        ...
        new_conclusions = self.conclusions()
        
        while new_conclusions:
            for sentence in new_conclusions:
    ...
    def new_knowledge(self):    
        ...
        while info:
            ...
            for cell in self.safes:
                info = self.mark_safe(cell)
            for cell in self.mines:
                info = self.mark_mine(cell)
                    ...
                    if s2.cells == set():
                        ...
                        if s1 != s2:
                            if s2.cells.issubset(s1.cells):
                                ...
                                diff_len = s1.count - s2.count
                                
                                conclusion = Sentence(diff, diff_len)
                            
                                if conclusion not in self.knowledge:
                                    conclusions.append(conclusion)
        self.knowledge = [sentence for sentence in self.knowledge if sentence not in cuts]
